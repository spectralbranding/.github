...
**The full accounting, marked stage by stage with the paper keys behind each verdict**, is published rather than summarised: the brand chain at [spectralbranding.com/open-problems](https://spectralbranding.com/open-problems), and the three organizational maps at [orgschema.com/coverage](https://orgschema.com/coverage). Both list what is owned, touched, ceded and empty, and both name the gaps worth filling.
