...
| [**sbt-papers**](https://github.com/spectralbranding/sbt-papers) | Research papers — framework specification, epistemological pipeline, mathematical foundations (R0-R20), and companion papers. 20+ working papers on [Zenodo](https://zenodo.org/communities/spectral-branding/), 16 under journal review. |
