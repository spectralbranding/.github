...
| [**negotiation-spec-experiment**](https://github.com/spectralbranding/negotiation-spec-experiment) | Empirical study — specify an LLM negotiator's objective, or style it? Value headroom decides: specification creates joint value when there is room to create it (by teaching logrolling) and ties at the ceiling. 7 arms, 4,920 dyads, 3 model families. [Zenodo](https://doi.org/10.5281/zenodo.20595996). Spec beats style when it matters. |
